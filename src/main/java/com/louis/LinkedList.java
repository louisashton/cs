 ...
 * 
 * Linked lists implement the list abstract data type. Each member contains a reference to the next member. In this 
 * doubly linkedlist, they also contain a reference to the previous member.
 * 
