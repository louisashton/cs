 ...
 * 
 * The Two-Phase Revised Simplex method solves a system of linear equations, A * x = b. An equation
 * in standard form is inputted from contorlling external code. Variable names were specified in the
 * assignment.
 * 
...
public class LinearProgram {
    ...
    /*
     * Updates the inverse for the constraint coefficients of the basic variables.
     */
    ...
    /*
     * The total cost is equal to the coefficients of the basic variables multiplied by their
     * values.
     * 
    ...
    public void eliminateArtificialVariables() {
        ...
        /*
         * Moves the real basic variables to the beginning of the matrix. Artificial variables are
         * shifted to the right. basisAugmentation will eliminate them.
         */
     ...
     * 
     * Augments a partial basis to give us the columns required for a full implmentation, by
     * eliminating artifical variables.
     * 
     * @param sizeOfBasis is the output width of the basis (the number of basic variables).
     * 
    ...
    public int basisAugmentation(int sizeOfBasis) {
        ...
        /*
         * Transfer columns of A to basicNormal. The current basis is in the first sizeOfBasis
         * locations. The remaining columns are in the last cols-sizeOfBasis locations. getAPerm
         * keeps track of the permutations.
         */
        ...
        /*
         * Finds m-sizeOfBasis columns by choosing the largest pivot in each row.
         */
